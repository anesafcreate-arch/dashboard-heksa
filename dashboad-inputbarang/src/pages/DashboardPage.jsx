...
import JadwalOnsiteTable from '../components/ui/JadwalOnsiteTable';
...
export default function DashboardPage() {
  ...
  const getRoleTitle = () => {
    const titles = {
      ...
      manager_dian: 'Dashboard Eksekutif',
      manager_fida: 'Dashboard Eksekutif',
      manager_uko: 'Dashboard Eksekutif',
    };
    ...
    <div className="dashboard-page page-container">
      ...
      {!isTeknisi && (
        <div className="dashboard-onsite-section">
          <div className="dashboard-onsite-scroll">
            <JadwalOnsiteTable />
          </div>
        </div>
      )}
